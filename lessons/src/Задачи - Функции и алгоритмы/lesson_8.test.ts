...
test('get Triangle Type', () => {
    ...
    expect(getTriangleType(2, 3, 3)).toBe('03-Методы массивов, slice, splice, toSpliced, reduce')
    expect(getTriangleType(3, 3, 2)).toBe('03-Методы массивов, slice, splice, toSpliced, reduce')
    expect(getTriangleType(4, 5, 3)).toBe('07_Promises, create Promise, .then .catch .finally')
